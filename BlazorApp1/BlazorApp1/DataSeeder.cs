...
public class DataSeeder
{
    ...
    private void SeedUserRoles()
    {
        ...
        var userRoleExists = _context.UserRoles.Any(ur => ur.UserId == "d4985dee-8e04-4d0f-8646-be9baa270bbf" && ur.RoleId == "c5b5e1e7-d5d4-4d4b-a9d9-2bb3cfc2431f");
        
        if (!userRoleExists)
        {
            // Add the user-role association if it doesn't exist
            _context.Roles.Add(new IdentityRole { Id = "c5b5e1e7-d5d4-4d4b-a9d9-2bb3cfc2431f", Name = "Admin"});
            _context.UserRoles.Add(new IdentityUserRole<string> { UserId = "d4985dee-8e04-4d0f-8646-be9baa270bbf", RoleId = "c5b5e1e7-d5d4-4d4b-a9d9-2bb3cfc2431f" });
    ...
    //         };
    //
    //         _userManager.CreateAsync(adminUser, "AdminPassword123").Wait();
    ...
    //         };
    //
    //         _userManager.CreateAsync(regularUser, "UserPassword123").Wait();
    //         _userManager.AddToRoleAsync(regularUser, "User").Wait();
    //
...
//     new Appointment { Date = "2024-06-10", Time = "10:00", Reason = "free", PatientId = null, DoctorId = 1, Status = "free" },
//     new Appointment { Date = "2024-06-11", Time = "11:00", Reason = "free", PatientId = null, DoctorId = 2, Status = "free" },
//     new Appointment { Date = "2024-06-12", Time = "12:00", Reason = "free", PatientId = null, DoctorId = 3, Status = "free" },
//     new Appointment { Date = "2024-06-13", Time = "13:00", Reason = "free", PatientId = null, DoctorId = 4, Status = "free" },
//     new Appointment { Date = "2024-06-14", Time = "14:00", Reason = "free", PatientId = null, DoctorId = 5, Status = "free" },
//     new Appointment { Date = "2024-06-15", Time = "15:00", Reason = "free", PatientId = null, DoctorId = 1, Status = "free" },
//     new Appointment { Date = "2024-06-16", Time = "16:00", Reason = "free", PatientId = null, DoctorId = 2, Status = "free" },
//     new Appointment { Date = "2024-06-17", Time = "17:00", Reason = "free", PatientId = null, DoctorId = 3, Status = "free" },
//     new Appointment { Date = "2024-06-18", Time = "18:00", Reason = "free", PatientId = null, DoctorId = 4, Status = "free" },
//     new Appointment { Date = "2024-06-19", Time = "19:00", Reason = "free", PatientId = null, DoctorId = 5, Status = "free" },
//     new Appointment { Date = "2024-06-20", Time = "10:00", Reason = "free", PatientId = null, DoctorId = 1, Status = "free" },
//     new Appointment { Date = "2024-06-21", Time = "11:00", Reason = "free", PatientId = null, DoctorId = 2, Status = "free" },
//     new Appointment { Date = "2024-06-22", Time = "12:00", Reason = "free", PatientId = null, DoctorId = 3, Status = "free" },
//     new Appointment { Date = "2024-06-23", Time = "13:00", Reason = "free", PatientId = null, DoctorId = 4, Status = "free" },
//     new Appointment { Date = "2024-06-24", Time = "14:00", Reason = "free", PatientId = null, DoctorId = 5, Status = "free" },
//     new Appointment { Date = "2024-06-25", Time = "15:00", Reason = "free", PatientId = null, DoctorId = 1, Status = "free" },
//     new Appointment { Date = "2024-06-26", Time = "16:00", Reason = "free", PatientId = null, DoctorId = 2, Status = "free" },
//     new Appointment { Date = "2024-06-27", Time = "17:00", Reason = "free", PatientId = null, DoctorId = 3, Status = "free" },
//     new Appointment { Date = "2024-06-28", Time = "18:00", Reason = "free", PatientId = null, DoctorId = 4, Status = "free" },
//     new Appointment { Date = "2024-06-29", Time = "19:00", Reason = "free", PatientId = null, DoctorId = 5, Status = "free" },
//      new Appointment
//                 {
